...
CObjFlyEnemy2::CObjFlyEnemy2(float x, float y)
{
	m_px = x;
	m_py = y;
}

void CObjFlyEnemy2::Init()
{
	...
	count = 0;
	m_hp = 10;
	Hits::SetHitBox(this, m_px, m_py, 64, 64, ELEMENT_ENEMY, OBJ_FLYENEMY2, 1);
}
void CObjFlyEnemy2::Action()
{
	m_time++;
	...
	//ブロックとの当たり判定実行
	block2->BlockHit2(&m_px, &m_py, false,
